    ...
    return (
        ...
        <Row>
          <Col md={6} lg={4}className="greybox" >
            <img id="featured-image-ricardo"  src='https://labs.chiedo.com/wp-content/themes/chiedolabs/img/wp-landing-page/img-ricardo-monicle.jpg'/>
          </Col>
          ...
          <Col md={12} lg={3} id="PostColumn" style={{ fontSize: '2.5rem', textAlign: 'center' }}>
            ...
            <a className="greybox" href={this.state.currentBlogLink}>
              <div id="featuredPostLink" >{this.state.currentBlogTitle}</div>
            </a>
          </Col>
        </Row>
      </Container>
